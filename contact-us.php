...
<html>
 	<head>
		<title>Loak.com - From trash to treasure</title>
		<meta charset=utf-8 >
...
<!-- JS begin some js files in bottom of file-->
	...
	<body>
      ...
      <div id="loader3" class="loader-cont">Please enable JS</div>
			...
			<div class="grey-bg"> <!-- Grey BG  -->	
                ...
                <div class="logo-2">
                  <a href="index.html" class="clearfix">
                    <img src="http://res.cloudinary.com/muhammadyana/image/upload/v1506167191/LOGO_png_kaozdc.png" class="logo-img" alt="Logo">
                  </a>
                </div>
              </div>
						<!-- BUTTON --> 
                    ...
                    <nav class="collapse collapsing navbar-collapse right-1024">
                      <ul class="nav navbar-nav">
                        ...
                        <li class="parent">
                          <a href="#" class="open-sub"><div class="main-menu-title">Service</div></a>
                          <ul class="sub">
                            <li><a href="">Upcycling</a></li><li><a href="jual-barang-bekas.php">Jual barang bekas</a></li><li><a href="">Produk Upcycle</a></li>
                          </ul>
                        </li>
                        <li class="parent current">
                          <a href="contact-us.html" class="open-sub"><div class="main-menu-title">Contact Us</div></a>
                        </li>
                         <li class="parent">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="breadcrumbs2 font-poppins">
                  <a class="a-inv" href="index.html">home</a><span class="slash-divider">/</span><span class="bread-current">contact</span>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="row row-sm-fix">
                    <div data-address="Dago, Bandung City, West Java" id="google-map"></div>
                  </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6">
                <div class="cis-cont">
                  ...
                  <div class="cis-text">
                    <h3>Email</h3>
                    <p><a href="mailto:info@elementy.com">hello.loak@gmail.com</a></p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 col-sm-6">
                <div class="cis-cont">
                  ...
                  <div class="cis-text">
                    <h3>Call Us</h3>
                    <a href="https://api.whatsapp.com/send?phone=6289609008541">+62-896-0900-8541</a>
                  </div>
                </div>
              </div>
        ...
        <!-- FOOTER 4 BLACK -->
        <div class="page-section pt-160-b-120-cont" style="background-color: #1E2D44">
          <div class="container">
              ...
              <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="mb-70 wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                  <div class="fes17-title-cont">
                    <div class="fes17-box-icon" style="color: white">
                      <img class="img img-responsive" src="http://res.cloudinary.com/muhammadyana/image/upload/v1506154468/logo-loak_t7auod.png" alt="">
                    </div>
...
<!-- JS begin -->
    ...
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyAgPpgOeWedR2DXbnJYcg0hI9rFGVJQ5dw"></script>
